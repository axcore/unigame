...
-- @@@ new
local group_stereotypes = {
    dye = "unilib:dye_white",
    wool = "unilib:wool_white",
    coal = "unilib:mineral_coal_lump",
    vessel = "unilib:vessel_bottle_glass_empty",
    flower = "unilib_flowers_dandelion_yellow"
}
...
--  end
    ...
    if #groups == 1 then
        ...
        if group_stereotypes[group] then
            return group_stereotypes[group]
        elseif minetest.registered_items["unilib:"..group] then
            return "unilib:"..group
        end
    end
