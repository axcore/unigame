...
-- @@@ Temporarily provide furnaces, because pipeworks needs to copy their definitions
...
-- @@@ Once the definitions have been copied, we can hide them

minetest.after(0.1, function()

    for _, full_name in pairs({"default:furnace", "default:furnace_active"}) do
